...
Połączenie badań nad algorytmami z pracami inżynierskimi nad aplikacją ma doprowadzić do stworzenia kompletnego systemu gotowego do oceny w rzeczywistych warunkach klinicznych.
    ...
    [MK]
A po drugie, trzeba będzie zerknąć na to co kiedyś kminiliśmy z Piórkowską i zacytować te prace.
    [/MK]
...
\begin{itemize}
    \item Naszej opiekun ZPI dr inż. Natalii Piórkowskiej za zarządzanie naszą pracą
    \item \href{https://www.umw.edu.pl}{Uniwersytetowi Medycznemu we Wrocławiu} za udostępnienie danych do trenowania modeli
